...
pub fn createStep(b: *std.Build, targets: []*std.Build.Step.Compile) *std.Build.Step {
...
fn makeCdb(step: *std.Build.Step, prog_node: std.Build.Step.MakeOptions) anyerror!void {
